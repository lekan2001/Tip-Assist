...
- (IBAction)onEdit:(id)sender {
    ...
    self.totalLabel.textColor = [UIColor systemGreenColor];
...
- (IBAction)onEditingBegin:(id)sender {
    [UIView animateWithDuration:0.5 animations:^{    self.billField.frame = CGRectMake( self.billField.frame.origin.x, self.billField.frame.origin.y +30, self.billField.frame.size.width, self.billField.frame.size.height);
